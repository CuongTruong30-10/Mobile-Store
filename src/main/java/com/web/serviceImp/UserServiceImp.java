...
public class UserServiceImp implements UserService {
    ...
    public TokenDto login(String username, String password, String tokenFcm) throws Exception {
        ...
        if(passwordEncoder.matches(password, users.get().getPassword())){
            ...
            //Đăng nhập thành công tạo ra 1 token
    ...
    public User regisUser(User user) {
        ...
        if(isValidEmailAddress(user.getEmail())){
            ...
            throw new MessageException("Email không đúng định dạng");
        }
        ...
        user.setActived(false); // Đăng ký set active = false
    ...
    public void activeAccount(String activationKey, String email) {
        ...
        // Lấy ra user có key và email truyền vào
        //Khi Post lên tài khoản sẽ active
    ...
    public void forgotPassword(String email) {
        ...
        // Set cho pass mới của user là randomPass
